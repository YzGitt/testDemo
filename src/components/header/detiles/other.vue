<template>
  <div>
    <div class="other">
      <div class="color">
        <div class="span">卡卷颜色</div>
        <div class="input">
<!--          <el-color-picker v-model="otherFrom.color1" size="mini"></el-color-picker>-->
          <colorsPro v-on:childColor="childColor"></colorsPro>
        </div>
      </div>
      <div class="date">
      ...
      <div class="useRule">
        ...
        <div  style="padding-top: 20px">
          <el-checkbox label="最低消费">最低消费<el-input v-model="otherFrom.downSale"  size="mini" style="width: 115px"></el-input>元可用</el-checkbox>
        </div>
...
<script>
  ...
  import colorsPro from  '../../colorsPro'
    export default {
        name: "other",
      components:{
        colorsPro
        ...
        methods:{
          ...
          childColor(childValue) {
            this.otherFrom.color1 = childValue
          }
        },
    }
</script>
